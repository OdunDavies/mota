...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-sarkimota-black">
      <div className="absolute inset-0 bg-gradient-to-b from-sarkimota-black via-sarkimota-black/90 to-sarkimota-black/80 z-10" />
      <div
        className="absolute inset-0 bg-cover bg-center opacity-35"
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=2000&auto=format&fit=crop)' }}
      />
      ...
      <Container className="relative z-30 text-center">
        ...
        >
          Nigeria&apos;s premier destination for luxury vehicles, premium financing, 
          and world-class aftermarket services.
        </motion.p>
        ...
        >
          <Link href="/inventory">
            <Button variant="gold" size="lg">Browse Inventory</Button>
          </Link>
          <Link href="/contact">
            <Button variant="dark" size="lg">Contact Sales</Button>
          </Link>
        </motion.div>
      </Container>
